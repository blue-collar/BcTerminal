 ...
 * @date 2019/1/10
 */
public class RoutePlanChoiceAddressActivity extends BaseActivity {
    ...
    protected void setUpViewAndData(Bundle savedInstanceState) {
        ...
        initView();
        initMap();
        isBegin = getIntent().getIntExtra("isBegin", 0);
        currentAddress = getIntent().getStringExtra("Address");
        currentLatLng = getIntent().getParcelableExtra("LatLng");

        if (currentAddress != null && currentLatLng != null) {
            PoiNearbySearchOption option = new PoiNearbySearchOption();
            option.keyword(currentAddress);
    ...
    private void initView() {
        ...
        qiandaoAddressSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RoutePlanChoiceAddressActivity.this, RoutePlanSearchAddressActivity.class);
        ...
        permissionHelper.requestPermissions("需要定位权限", new PermissionHelper.PermissionListener() {
            ...
            public void doAfterGrand(String... permissions) {
                if (mLocationClient == null) {
                    mLocationClient = new LocationClient(RoutePlanChoiceAddressActivity.this);
    ...
    private OnGetPoiSearchResultListener onGetPoiSearchResultListener = new OnGetPoiSearchResultListener() {
        ...
        public void onGetPoiResult(PoiResult poiResult) {
            if (poiResult == null || poiResult.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
                Toast.makeText(RoutePlanChoiceAddressActivity.this, "未找到结果", Toast.LENGTH_LONG).show();
                return;
            }
            if (poiResult.error == SearchResult.ERRORNO.NO_ERROR) {
                ...
                // 通知适配数据已改变
                mAdapper = new LocationAdapter(RoutePlanChoiceAddressActivity.this, mInfoList);
