...
public class AidlUtil {
     ...
     * 加粗
     */
    public void printAddressText(String address) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            ...
            woyouService.printTextWithFont(address, null, 32, null);
     ...
     * 标题加粗居中
     */
    public void printTitleText(String title) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            ...
            woyouService.printTextWithFont(title, null, 36, null);
     ...
     * 不加粗居左
     */
    public void printStrText(String str) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            ...
            woyouService.sendRAWData(ESCUtil.alignLeft(), null);
            woyouService.printTextWithFont(str, null, 24, null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
     ...
     * 不加粗居左
     */
    public void printContentText(String content) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            woyouService.sendRAWData(ESCUtil.boldOff(), null);
            woyouService.sendRAWData(ESCUtil.alignLeft(), null);
            woyouService.sendRAWData(ESCUtil.setContentLineSpacing(), null);
            woyouService.printTextWithFont(content, null, 26, null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
     ...
     *打印居右图片
     */
    public void printRightBitmap(Bitmap bitmap) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void cutterPage() {
        ...
        try {
            woyouService.sendRAWData(ESCUtil.cutter(), null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void printSplitLine() {
        ...
        try {
            woyouService.sendRAWData(ESCUtil.alignLeft(), null);
            woyouService.sendRAWData(ESCUtil.splitLine(), null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
