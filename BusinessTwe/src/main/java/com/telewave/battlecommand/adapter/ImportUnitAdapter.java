 ...
 * @date 2019/8/6
 */
public class ImportUnitAdapter extends RecyclerView.Adapter<ImportUnitAdapter.MyViewHolder> {
    ...
    public ImportUnitAdapter(Context mContext, List<ImportUnit> importUnits) {
        super();
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.import_unit_item, parent, false);
