...
public class DetailPhotoAdapter extends RecyclerView.Adapter<DetailPhotoAdapter.MyViewHolder> {
    ...
    public DetailPhotoAdapter(Context context, List<FightPicInfo> datas, int maxNum) {
        mContext = context;
        mDatas = datas;
        mMaxNum = maxNum;
