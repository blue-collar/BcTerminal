 ...
 */
public class TRTCAudioViewLayout extends RelativeLayout {
    private final static String TAG = TRTCAudioViewLayout.class.getSimpleName();
    ...
    public interface ITRTCVideoViewLayoutListener {
         ...
         * @param userName
         */
        void onChangeVideoShowFrame(String userName);
    }

    public TRTCAudioViewLayout(Context context) {
        super(context);
        initView(context);
    }


    public TRTCAudioViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public TRTCAudioViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void addToolbarLayout(final TXCloudVideoView videoView) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.audio_layout_toolbar, videoView);
            ...
            final ImageView audioCallToChat = (ImageView) view.findViewById(R.id.audiocall_to_chat);
            audioCallToChat.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    String userId = videoView.getUserId();
                    if (userId != null) {
                        ...
                        if (onAudioToChatClickListener != null) {
                            onAudioToChatClickListener.onAudioToChatClick(userId);
                        }
                    }
                }
            });
...
//                    }
    ...
    public interface OnAudioToChatClickListener {
        void onAudioToChatClick(String userId);
    }

    private OnAudioToChatClickListener onAudioToChatClickListener;

    public void setOnAudioToChatClickListener(OnAudioToChatClickListener onAudioToChatClickListener) {
        this.onAudioToChatClickListener = onAudioToChatClickListener;
    }
}
