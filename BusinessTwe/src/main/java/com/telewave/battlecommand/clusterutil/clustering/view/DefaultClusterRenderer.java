...
package com.telewave.battlecommand.clusterutil.clustering.view;
...
import com.telewave.battlecommand.clusterutil.projection.Point;
import com.telewave.battlecommand.clusterutil.projection.SphericalMercatorProjection;
import com.telewave.battlecommand.clusterutil.ui.IconGenerator;
import com.telewave.battlecommand.clusterutil.ui.SquareTextView;
...
import static com.telewave.battlecommand.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, BaiduMap map, ClusterManager<T> clusterManager) {
        this(context, map, R.drawable.map_cluster_bg_normal, clusterManager);
    }

    public DefaultClusterRenderer(Context context, BaiduMap map, int resId, ClusterManager<T> clusterManager) {
        mMap = map;
        mDensity = context.getResources().getDisplayMetrics().density;
        mIconGenerator = new IconGenerator(context, resId);
