...
package com.telewave.battlecommand.clusterutil.clustering;
...
import com.telewave.battlecommand.clusterutil.MarkerManager;
import com.telewave.battlecommand.clusterutil.clustering.algo.Algorithm;
import com.telewave.battlecommand.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.telewave.battlecommand.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.telewave.battlecommand.clusterutil.clustering.view.ClusterRenderer;
import com.telewave.battlecommand.clusterutil.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public ClusterManager(Context context, BaiduMap map) {
        this(context, map, R.drawable.map_cluster_bg_normal, new MarkerManager(map));
    }

    public ClusterManager(Context context, BaiduMap map, int resId) {
        this(context, map, resId, new MarkerManager(map));
    }

    public ClusterManager(Context context, BaiduMap map, int resId, MarkerManager markerManager) {
        mMap = map;
        mMarkerManager = markerManager;
        mClusterMarkers = markerManager.newCollection();
        mMarkers = markerManager.newCollection();
        mRenderer = new DefaultClusterRenderer<T>(context, map, resId, this);
