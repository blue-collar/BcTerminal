...
public class UnitOutwardFragment extends BaseFragment implements IDirectionContract.IPlanUnitDetailView {

    private static final String TAG = "UnitOutwardFragment";
    ...
    public UnitOutwardFragment(Context context, String title, String id) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_plan_unit_outward, container, false);
        initView();
    ...
    private void initView() {
        ...
        mPicReclView = mView.findViewById(R.id.plan_unit_outward_pic);
