...
import com.telewave.lib.log.upload.AppBussInfo;
 ...
 * 1. 在工程中引用TweLog的jar包，不需要对这个jar再次混淆（已经是混淆后的jar文件）
 * 2. 工程中需要实现TweLogConfig这个类（具体说明参见TweLogBaseConfig注释），同时工程混淆时要排除TweLogConfig
 */
public class TweLog {

    /**
     * Priority constant for the println method; use TweLog.v.
     */
    public static final int VERBOSE = 2;

    /**
     * Priority constant for the println method; use TweLog.d.
     */
    public static final int DEBUG = 3;

    /**
     * Priority constant for the println method; use TweLog.i.
     */
    public static final int INFO = 4;

    /**
     * Priority constant for the println method; use TweLog.w.
     */
    public static final int WARN = 5;

    /**
     * Priority constant for the println method; use TweLog.e.
     */
    ...
    /**
     * Priority constant for the println method, use TweLog.trace.
     */
    ...
    public static void v(String tag, String msg) {
        TweLogImpl.getInstance().log('v', tag, msg, null);
    }
    ...
    public static void v(String tag, String msg, Throwable tr) {
        TweLogImpl.getInstance().log('v', tag, msg, tr);
    }
    ...
    public static void v(String tag, String format, Object... args) {
        TweLogImpl.getInstance().log('v', tag, formatArgs(format, args), null);
    }
    ...
    public static void d(String tag, String msg) {
        TweLogImpl.getInstance().log('d', tag, getLineMethod() + msg, null);
    }
    ...
    public static void d(String tag, String msg, Throwable tr) {
        TweLogImpl.getInstance().log('d', tag, msg, tr);
    }
    ...
    public static void d(String tag, String format, Object... args) {
        TweLogImpl.getInstance().log('d', tag, formatArgs(format, args), null);
    }
    ...
    public static void i(String tag, String msg) {
        TweLogImpl.getInstance().log('i', tag, msg, null);
    }
    ...
    public static void i(String tag, String msg, Throwable tr) {
        TweLogImpl.getInstance().log('i', tag, msg, tr);
    }
    ...
    public static void i(String tag, String format, Object... args) {
        TweLogImpl.getInstance().log('i', tag, formatArgs(format, args), null);
    }
    ...
    public static void w(String tag, String msg) {
        TweLogImpl.getInstance().log('w', tag, msg, null);
    }
    ...
    public static void w(String tag, Throwable tr) {
        TweLogImpl.getInstance().log('w', tag, null, tr);
    }
    ...
    public static void w(String tag, String msg, Throwable tr) {
        TweLogImpl.getInstance().log('w', tag, msg, tr);
    }
    ...
    public static void w(String tag, String format, Object... args) {
        TweLogImpl.getInstance().log('w', tag, formatArgs(format, args), null);
    }
    ...
    public static void e(String tag, String msg) {
        TweLogImpl.getInstance().log('e', tag, msg, null);
    }
    ...
    public static void e(String tag, String msg, Throwable tr) {
        TweLogImpl.getInstance().log('e', tag, msg, tr);
    }
    ...
    public static void e(String tag, Throwable throwable) {
        TweLogImpl.getInstance().log('e', tag, null, throwable);
    }
    ...
    public static void e(String tag, String format, Object... args) {
        TweLogImpl.getInstance().log('e', tag, formatArgs(format, args), null);
    }
    ...
    public static void wtf(String tag, String msg) {
        TweLogImpl.getInstance().log('t', tag, msg, null);
    }
    ...
    public static void wtf(String tag, Throwable tr) {
        TweLogImpl.getInstance().log('t', tag, null, tr);
    }
    ...
    public static void wtf(String tag, String msg, Throwable tr) {
        TweLogImpl.getInstance().log('t', tag, msg, tr);
    }
    ...
    public static void trace(int module, String tag, String msg) {
        TweLogImpl.getInstance().trace(module, tag, msg, null);
    }
    ...
    public static void trace(int module, String tag, Throwable throwable) {
        TweLogImpl.getInstance().trace(module, tag, "", throwable);
    }
    ...
    public static void trace(String tag, String msg) {
        TweLogImpl.getInstance().trace(0, tag, msg, null);
    }
    ...
    public static void trace(String tag, Throwable throwable) {
        TweLogImpl.getInstance().trace(0, tag, "", throwable);
    }
    ...
    public static void crash(String tag, Throwable throwable) {
        TweLogImpl.getInstance().crash(tag, throwable);
    }
    ...
    public static void crash(String tag, String msg) {
        TweLogImpl.getInstance().crash(tag, msg);
    }
    ...
    public static void registerLogReceiver(Context context) {
        TweLogImpl.getInstance().registerLogReceiver(context);
    }
    ...
    public static int reportTraceLogFilesByTools(String pkgName, String logFilePath, int netType,
        ...
        if (logFilePath == null || logFilePath.equals("")) {  // 未指定具体日志文件，上传默认路径下所有日志文件
            logPath = TweLogUtils.getLogFileDirectory(pkgName, false).getAbsolutePath();
        }
        return reportTraceInfoAndLogFiles("debugTool", 0, "debugTool_" + pkgName, null, null,
                TweLogUploadImpl.LOG_REPORT_TYPE_TOOL, logPath, pkgName, netType, uiCallBack);
    }
    ...
    public static void cancelReportLog(int resId) {
        TweLogUploadImpl.getInstance().cancelReportLogRequest(resId);
    }
    ...
    public static int reportTraceLogFiles() {
        return reportTraceInfoAndLogFiles("reportTraceLogFiles", 0, null, null, null,
                TweLogUploadImpl.LOG_PAHT_DEFAULT);
    }
    ...
    public static int reportTraceInfoAndLogFiles(String bussName, int errCode, String errMsg,
        ...
        return reportTraceInfoAndLogFiles(bussName, errCode, errMsg, extraFilePath, null,
                TweLogUploadImpl.LOG_REPORT_TYPE_APP, TweLogUploadImpl.LOG_PAHT_DEFAULT, null,
    ...
    public static int reportTraceInfoAndLogFiles(String bussName, int errCode,
        ...
        return reportTraceInfoAndLogFiles(bussName, errCode, errMsg, extraFilePath, extraData,
                TweLogUploadImpl.LOG_REPORT_TYPE_APP, logPath, null,
    ...
    private static int reportTraceInfoAndLogFiles(String bussName, int errCode, String errMsg,
        ...
        if (TweLogUploadImpl.LOG_PAHT_DEFAULT.equals(logPath)) {
            logPath = TweLogImpl.getInstance().getLogStoragePathStr();
        }
        // 设置上传的log相关信息
        ...
        return TweLogUploadImpl.getInstance().sendReportLogInfoMsg(appBussInfo);
    }
...
//        TweLogImpl.getInstance().notifyTraceLogOpened(context, modules, expireTime);
//    }
//
//    /**
...
//        TweLogImpl.getInstance().notifyTraceLogClosed(context);
//    }
//
//    /**
//     * 注册trace log监听器
...
//        TweLogImpl.getInstance().registerTraceLogReceiver(context);
//    }
//
//    /**
//     * 解注册trace log监听器
...
//        TweLogImpl.getInstance().unregisterTraceLogReceiver(context);
//    }
//
//    /**
//     * 准备上报trace log
...
//        return TweLogImpl.getInstance().prepareUploadTraceLog();
//    }
//
//
//**********************   2014-12-24  先屏蔽trace上报的相关功能 ******************
    ...
    //benylwang add
    public static boolean isTweLogOpen() {
        return TweLogImpl.getInstance().isTweLogOpen();
    }

    public static boolean isTweLoggable(String tag, int logLevel) {
        return TweLogImpl.getInstance().isTweLoggable(tag, logLevel);
    }
}
