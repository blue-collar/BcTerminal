    ...
    public void onGroupInfoModified(Object value, int type) {
        switch (type) {
            case TUIKitConstants.Group.MODIFY_GROUP_NAME:
                ToastUtils.toastLongMessage(getResources().getString(R.string.modify_group_name_success));
            ...
            case TUIKitConstants.Group.MODIFY_GROUP_NOTICE:
                ...
                ToastUtils.toastLongMessage(getResources().getString(R.string.modify_group_notice_success));
                break;
            ...
            case TUIKitConstants.Group.MODIFY_MEMBER_NAME:
                ToastUtils.toastLongMessage(getResources().getString(R.string.modify_nickname_success));
