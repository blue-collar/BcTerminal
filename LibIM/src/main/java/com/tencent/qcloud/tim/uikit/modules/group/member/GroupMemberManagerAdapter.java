    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                int padding = ScreenUtils.getPxByDp(10);
                    ...
                    public void onClick(View v) {
                        ...
                        provider.removeGroupMembers(dels, new IUIKitCallBack() {
                            ...
                            public void onError(String module, int errCode, String errMsg) {
                                TUIKitLog.e(String.format(Locale.CHINA, "class：GroupMemberManagerAdapter  module：%s  errCode：%s  errMsg：%s", module, errCode, errMsg));
