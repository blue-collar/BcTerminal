...
public class MediaPlayTool {
    ...
    private static final String TAG = "MediaPlayTool";

    private static MediaPlayTool mInstance = null;
    ...
    synchronized public static MediaPlayTool getInstance() {
        if (null == mInstance) {
            mInstance = new MediaPlayTool();
        }
        return mInstance;
    }
    ...
    private boolean play(String urlPath, boolean isEarpiece, int seek) {
        Log.e(TAG, "play---urlPath=" + urlPath);
