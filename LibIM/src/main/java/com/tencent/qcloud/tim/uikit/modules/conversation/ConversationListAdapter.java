...
public class ConversationListAdapter extends IConversationAdapter {
    ...
    public int mSingleItemImage = 0;
    public int mGroupItemImage = 0;

    public void setSingleItemImage(int iconRes) {
        mSingleItemImage = iconRes;
    }

    public void setGroupItemImage(int iconRes) {
        mGroupItemImage = iconRes;
    }
