            ...
            public void onClick(View v) {
                ...
                provider.inviteGroupMembers(mInviteMembers, new IUIKitCallBack() {
                    ...
                    public void onSuccess(Object data) {
                        TUIKitLog.e("邀请成员成功===" + data.toString());
                    ...
                    public void onError(String module, int errCode, String errMsg) {
                        TUIKitLog.e(String.format(Locale.CHINA, "class：GroupMemberInviteLayout  module：%s  errCode：%s  errMsg：%s", module, errCode, errMsg));
