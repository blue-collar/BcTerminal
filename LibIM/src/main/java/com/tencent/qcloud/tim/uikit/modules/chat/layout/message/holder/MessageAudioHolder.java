...
public class MessageAudioHolder extends MessageContentHolder {
    ...
    private static final int AUDIO_MIN_WIDTH = ScreenUtils.getPxByDp(60);
    private static final int AUDIO_MAX_WIDTH = ScreenUtils.getPxByDp(250);
    ...
    public void layoutVariableViews(final MessageInfo msg, final int position) {
        ...
        audioParams.width = AUDIO_MIN_WIDTH + ScreenUtils.getPxByDp(duration * 6);
